    ...
    list = [
        {
            ...
            "data": { "username": '0' + number, "force_send_otp": true, "otp_call": true },
            "name": "DigiKala",
            "type": "WEB",
            "method": "POST"
        },
        {
            ...
            "utl": `https://digitalsignup.snapp.ir/ds3/api/v3/otp?utm_source=snapp.ir&utm_medium=website-button&utm_campaign=menu&cellphone=0${phone}`,
