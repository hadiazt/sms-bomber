...
<h3 align="center">
Have Fun By Spamming To Your Friends ;D
</h3>
...
```
`time` Its In MS Mode</br>
`number` Enter The Target Number Without 0 Or 98(Iran Code)
</br>

<p align="center">
    <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/hadiazt/sms-bomber">
    &nbsp;
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/hadiazt/sms-bomber">
    &nbsp;
